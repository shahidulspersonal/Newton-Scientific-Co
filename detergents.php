...
<head>
    ...
    <title>Detergents for Textile Testing in BD</title>

    <meta name="description" content="Discover a wide range of detergents for textile testing in Bangladesh, including Non Phosphate and Phosphate detergents. Feel free to Contact us at 01815491313.">

    <meta name="author" content="Newton Scientific Co.">
    <meta property="og:title" content="Detergents for Textile Testing in BD">
    <meta property="og:description" content="Discover a wide range of detergents for textile testing in Bangladesh, including Non Phosphate and Phosphate detergents. Feel free to Contact us at 01815491313.">
    <meta property="og:url" content="https://newtonscientificbd.com/detergent-products">
    <meta property="og:type" content="website">
    <meta property="og:image" content="https://newtonscientificbd.com/images/detergents.webp">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <!-- Canonical Tag -->
    <link rel="canonical" href="https://newtonscientificbd.com/detergent-products" />
...
<body>
    ...
    <h1 class="text-2xl font-bold container mx-auto pt-2 text-blue-600">
        Detergents for Textile Testing in BD
    </h1>
    <br>
    <p class="text-base container mx-auto text-justify">
        Discover our comprehensive range of detergents for textile testing, including both non-phosphate and phosphate detergents. Trust Newton Scientific for all your detergent needs in Bangladesh to ensure top-quality textile testing.
    </p>
    ...
    <div class="container mx-auto mt-8">
        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            // SQL query to select all products from the 'detergent' category
            $query = "
            SELECT * FROM product 
            WHERE category = 'detergent'
            ORDER BY name ASC
        ";
